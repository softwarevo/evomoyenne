...
## 🛠️ Améliorations
- 📊 La valeur minimale du graphique est maintenant la pire moyenne, et la valeur maximale la meilleur moyenne, pour une meilleure lisibilité
- 🫥 Le cache se rafraîchit maintenant toutes les 6h pour la PWA ou à chaque chargement pour la PWA et le site pour prendre en compte les mises à jour
- 📱 La PWA ne crash plus et l'icône est mieux masquée
- 🐛 Le bouton feedback a été supprimé
