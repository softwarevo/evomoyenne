...
Ce logiciel est distribué sous licence **GNU Affero General Public License v3.0 (AGPL-3.0)**. 
Cela garantit que le code restera libre et transparent pour tous ses utilisateurs.
